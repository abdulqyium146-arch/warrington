...
export const metadata: Metadata = {
  title: 'Get a Free Car Detailing Quote — Car Ceramic Coating and detailing warrington0',
  description:
    'Get a free, no-obligation car detailing quote from Car Ceramic Coating and detailing warrington0 in Warrington. Tell us your vehicle, service, and location — we\'ll get back to you fast.',
  alternates: { canonical: `${SITE_URL}/get-a-quote` },
  openGraph: {
    title: 'Get a Free Car Detailing Quote — Car Ceramic Coating and detailing warrington0',
    description:
      'Get a free, no-obligation car detailing quote from Car Ceramic Coating and detailing warrington0 in Warrington.',
...
const faqs = [
  ...
  },
  {
    ...
    a: 'Car Ceramic Coating and detailing warrington0 is based at Unit 1 Fairclough Mill, Atherton\'s Quay, Warrington, WA5 1AH. Customers bring their vehicles to our unit for all services.',
  },
  {
      ...
      <section className="py-16 px-4 bg-brand-darkgray">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2">
            <div className="card-dark rounded-2xl p-8">
              ...
              <form
                ...
                className="space-y-6"
              >
                <input type="hidden" name="_subject" value="New Quote Request — Car Ceramic Coating and detailing warrington0" />
          ...
          <aside className="space-y-6">
            ...
            <div className="card-dark rounded-xl p-6">
              <h3 className="font-heading font-bold text-brand-white mb-4">
                Why Choose Car Ceramic Coating and detailing warrington0?
              </h3>
              <ul className="space-y-3">
                {[
                  'Unit-based — based at Fairclough Mill, Atherton\'s Quay, Warrington WA5',
