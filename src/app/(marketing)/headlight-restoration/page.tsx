...
const CANONICAL = 'https://warringtoncardetailing.co.uk/headlight-restoration/';
...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'yellowed headlight fix Warrington',
    'headlight polishing Warrington',
    'foggy headlight restoration Warrington',
    'headlight refurbishment Warrington',
  ],
  alternates: {
    canonical: CANONICAL,
  ...
  openGraph: {
    ...
    description: 'Professional headlight restoration in Warrington from £50. Restore yellowed, cloudy headlights to crystal clarity. Improves night visibility & MOT results.',
    url: CANONICAL,
    siteName: 'Car Ceramic Coating and detailing warrington0',
    locale: 'en_GB',
    type: 'website',
    images: [{ url: '/hero-bg.jpg', width: 1200, height: 630, alt: 'Headlight restoration in Warrington by Car Ceramic Coating and detailing warrington0 — restoring yellowed headlights to crystal clarity' }],
  },
  twitter: {
...
const headlightFaqs = [
  ...
  },
  {
    ...
    answer: 'Professional headlight restoration typically takes 45–90 minutes for a pair of headlights. Results are immediately visible. Car Ceramic Coating and detailing warrington0 applies a UV-resistant protective sealant after polishing to protect the restored clarity.',
  },
  {
    question: 'Can all headlights be restored?',
    answer: "Most modern polycarbonate (plastic) headlights can be fully restored. Very severely cracked or internally fogged lenses may require replacement rather than restoration. Car Ceramic Coating and detailing warrington0 will give you an honest assessment — we won't proceed if we can't deliver a great result.",
  },
  {
    question: 'Will restored headlights stay clear?',
    answer: 'Car Ceramic Coating and detailing warrington0 applies a professional UV-resistant sealant after polishing to prevent re-yellowing. Without this sealant, plastic lenses yellow again within weeks. With proper care, Car Ceramic Coating and detailing warrington0-restored headlights should remain crystal clear for 2–3 years.',
  },
  {
    question: 'Can cloudy headlights fail an MOT?',
    answer: 'Yes — severely yellowed or hazy headlights can fail an MOT if the reduced light output falls below the legal minimum. Headlight restoration can resolve this without the expense of replacing the entire headlight unit, which can cost hundreds of pounds.',
  },
];
  ...
  return (
    <>
      <JsonLd
        data={serviceSchema(
          'Headlight Restoration Warrington',
          'Professional headlight restoration in Warrington from £50. Restore yellowed, cloudy or hazy headlights to crystal clear condition. UV-resistant sealant applied for lasting results.',
          CANONICAL,
          '50'
        )}
      />
      <JsonLd
        data={breadcrumbSchema([
          ...
          { name: 'Headlight Restoration Warrington', url: CANONICAL },
        ])}
      />
      <JsonLd data={faqSchema(headlightFaqs)} />
