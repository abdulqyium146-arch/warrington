...
const CANONICAL = 'https://warringtoncardetailing.co.uk/ceramic-coating/';
...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'Gtechniq ceramic coating Warrington',
    'CarPro ceramic coating Warrington',
    'car paint protection Warrington',
    'new car ceramic coating Warrington',
    'ceramic coating Cheshire',
    'long lasting car protection Warrington',
  ],
  alternates: {
    canonical: CANONICAL,
  ...
  openGraph: {
    ...
    locale: 'en_GB',
    type: 'website',
    images: [{ url: '/gallery/ceramic-coating-seat-cupra-warrington-Car Ceramic Coating and detailing warrington0-car-detailing.jpg', width: 1200, height: 630, alt: 'Ceramic coating applied to Seat Cupra in Warrington by Car Ceramic Coating and detailing warrington0 — deep gloss hydrophobic finish' }],
  },
  twitter: {
...
const ceramicCoatingFaqs = [
  {
    ...
    answer: 'Professional ceramic coating typically lasts between 2 and 9+ years depending on the product grade. CarPro CQuartz UK 3.0 lasts 2–3 years, Gtechniq Crystal Serum Light lasts 3–5 years, and Gtechniq Crystal Serum Ultra carries a 9-year manufacturer warranty. Correct maintenance with pH-neutral shampoo and periodic ceramic boost spray will extend the lifespan significantly.',
  },
  {
    question: 'How much does ceramic coating cost in Warrington?',
    answer: 'Ceramic coating in Warrington at Car Ceramic Coating and detailing warrington0 starts from £250 for CarPro CQuartz UK 3.0 (2–3 year protection), £350 for Gtechniq Crystal Serum Light (3–5 years), and £650 for the flagship Gtechniq Crystal Serum Ultra with a 9-year manufacturer warranty. All packages include a paint correction preparation stage.',
  },
  {
    question: 'Does ceramic coating prevent scratches?',
    answer: 'Ceramic coatings add significant scratch resistance — rated at 9H hardness — making them highly resistant to light scratches and swirl marks from washing. However, they are not completely scratch-proof. Sharp or heavy impacts can still damage the coating and paint beneath. The coating significantly reduces the risk of swirl marks from regular washing.',
  },
  {
    question: 'Can ceramic coating be applied to a new car?',
    answer: "Absolutely — new car ceramic coating is one of Car Ceramic Coating and detailing warrington0's most popular services. Applying a professional-grade ceramic coating to a new car protects the factory paintwork from day one, preventing contamination, UV damage, bird dropping etching, and swirl marks before they develop. New cars still require a decontamination wash before coating.",
  },
  {
    question: 'How do I maintain a ceramic coated car?',
    answer: 'Use a pH-neutral car shampoo and a clean, soft microfibre wash mitt with the two-bucket method. Avoid automated car washes with brushes — these will cause swirl marks even on a coated surface. Apply a ceramic boost spray (such as Gtechniq EXOv4 or CarPro Reload) every 6–12 months to maintain the hydrophobic properties. Car Ceramic Coating and detailing warrington0 also offers a ceramic coating maintenance service.',
  },
];

const ceramicCoatingHowToSteps = [
  { name: 'Paint Assessment', text: "We inspect your car's paint using a paint depth gauge and specialist lighting to identify any defects, swirl marks, or scratches that need addressing before the coating is applied." },
  { name: 'Decontamination Wash', text: 'A thorough two-stage decontamination wash removes all bonded contaminants, iron fallout, tar deposits, and road grime from the paint surface using pH-neutral chemicals.' },
  { name: 'Paint Correction', text: 'Any swirl marks, scratches, or oxidation are corrected using machine polishers before coating. The ceramic coating permanently seals the finish, so the paint must be perfect first.' },
  { name: 'IPA Panel Wipe', text: 'All surfaces are wiped down with isopropyl alcohol (IPA) to remove any remaining polish oils, silicones, or residue — ensuring maximum chemical bonding adhesion for the coating.' },
  { name: 'Ceramic Coating Application', text: 'The coating is applied panel by panel in our controlled environment, carefully levelled and allowed to flash before buffing to a perfect finish. Multiple layers are applied for premium packages.' },
  { name: 'Curing & Final Inspection', text: 'The vehicle is left to cure for 24–48 hours before a final inspection under high-intensity lighting. We check for any high spots, smearing, or missed areas before handover.' },
];
  ...
  return (
    <>
      <JsonLd
        data={serviceSchema(
          'Ceramic Coating Warrington',
          'Professional ceramic coating in Warrington from £250. Accredited Gtechniq and CarPro installers. 9H hardness, up to 9-year protection. Paint correction prep included.',
          CANONICAL,
          '250'
        )}
      />
      <JsonLd
        data={breadcrumbSchema([
          ...
          { name: 'Ceramic Coating Warrington', url: CANONICAL },
        ])}
      />
      <JsonLd data={faqSchema(ceramicCoatingFaqs)} />
      <JsonLd data={howToSchema(
        ceramicCoatingHowToSteps,
        'How to Apply Ceramic Coating to a Car',
        'A step-by-step guide to the professional ceramic coating process used by Car Ceramic Coating and detailing warrington0.'
      )} />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
            <div>
              ...
              <div className="space-y-4 text-gray-300 leading-relaxed">
                ...
                <p>
                  At Car Ceramic Coating and detailing warrington0, we are accredited installers of{' '}
            ...
            {/* Real result — Seat Cupra ceramic coating */}
            <div className="relative rounded-2xl overflow-hidden border border-brand-gray">
              <div className="relative h-80">
                <Image
                  ...
                  alt="Ceramic coating applied to Seat Cupra in Warrington — deep gloss hydrophobic finish by Car Ceramic Coating and detailing warrington0 Car Detailing"
                  fill
                  className="object-cover"
                  sizes="(max-width: 768px) 100vw, 50vw"
                />
              </div>
              <div className="absolute bottom-0 left-0 right-0 px-4 py-2 bg-brand-black/70 text-xs text-gray-300 text-center">
                Real result — Seat Cupra ceramic coating, Warrington WA5
              </div>
