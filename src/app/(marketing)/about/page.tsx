...
export const metadata: Metadata = {
  title: 'About Car Ceramic Coating and detailing warrington0 — Warrington\'s Local Specialists',
  description:
    'Learn about Car Ceramic Coating and detailing warrington0 — Warrington\'s ceramic coating & machine polishing specialists. Professional car detailing at our Warrington unit. 5-star rated.',
...
const aboutSchema = {
  ...
  '@type': 'AboutPage',
  name: 'About Car Ceramic Coating and detailing warrington0',
  url: `${SITE_URL}/about`,
  description:
    'Car Ceramic Coating and detailing warrington0 is Warrington\'s premier ceramic coating and machine polishing specialists, based at our unit in Warrington WA5.',
  mainEntity: {
    '@type': 'LocalBusiness',
    name: 'Car Ceramic Coating and detailing warrington0',
    description:
      'Professional car detailing specialists based in Warrington, serving Cheshire and Greater Manchester.',
    address: {
      '@type': 'PostalAddress',
...
const reviews = [
  ...
  },
  {
    name: 'Sarah M.',
    location: 'Padgate',
    text: 'The ceramic coating on my BMW is absolutely stunning. Car Ceramic Coating and detailing warrington0 did an incredible job, the paint looks better than when the car was new. Highly recommend to anyone in Warrington.',
    rating: 5,
  },
  {
    name: 'Mike R.',
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="font-heading font-black text-4xl md:text-6xl text-brand-white mt-6 mb-6 leading-tight">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-gold to-yellow-300">
              Car Ceramic Coating and detailing warrington0
            </span>
          </h1>
          ...
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            Car Ceramic Coating and detailing warrington0 is a professional car detailing specialist based at Unit 1 Fairclough Mill, Atherton\'s Quay,
            Warrington, WA5 1AH. We serve customers across the WA1–WA5 postcodes, Cheshire, and Greater
            Manchester, delivering showroom-quality results.
          </p>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-300 text-lg leading-relaxed mb-4">
              Car Ceramic Coating and detailing warrington0 is Warrington&apos;s trusted name for professional car care. We
              specialise in machine polishing, ceramic coatings, full car detailing, and
              interior detailing — combining professional-grade products with genuine attention to
              detail.
            </p>
            <p className="text-gray-400 leading-relaxed mb-4">
              Based at Unit 1 Fairclough Mill, Atherton\'s Quay, Warrington WA5 1AH, we operate a fully mobile
      ...
      <section id="our-story" aria-label="Our story" className="py-20 px-4 bg-brand-black">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-gray-300 text-lg leading-relaxed mb-6">
            Car Ceramic Coating and detailing warrington0 was founded with a simple aim: to provide Warrington car owners with a
            genuinely professional detailing service that comes to them — no inconvenient drop-offs,
            no waiting around.
          </p>
          <p className="text-gray-400 leading-relaxed mb-6">
            What started as a local car detailing operation quickly expanded to cover the full
          ...
          <p className="text-gray-400 leading-relaxed">
            Today, Car Ceramic Coating and detailing warrington0 serves customers across Warrington, St Helens, Widnes, Runcorn,
