...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Contact Car Ceramic Coating and detailing warrington0 | Free Quote',
    description:
      'Call or message Car Ceramic Coating and detailing warrington0 for a free no-obligation quote. Unit-based service in Warrington WA5.',
...
const contactPageSchema = {
  ...
  '@type': 'ContactPage',
  name: 'Contact Car Ceramic Coating and detailing warrington0',
  url: `${SITE_URL}/contact`,
  mainEntity: {
    '@type': 'LocalBusiness',
            ...
            <div className="space-y-8">
              ...
              <address className="not-italic space-y-4">
                ...
                <div className="card-dark flex gap-5 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm mt-1">Customers bring their vehicle to our Warrington WA5 unit</p>
                  </div>
                </div>
              ...
              <div className="rounded-xl overflow-hidden border border-brand-gray/40">
                <iframe
                  ...
                  title="Car Ceramic Coating and detailing warrington0 location"
                />
              </div>
            </div>
