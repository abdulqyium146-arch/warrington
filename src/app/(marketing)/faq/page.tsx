...
const faqSchema = {
  ...
  '@type': 'FAQPage',
  mainEntity: [
    { '@type': 'Question', name: 'What is Car Ceramic Coating and detailing warrington0 and where are you based?', acceptedAnswer: { '@type': 'Answer', text: 'Car Ceramic Coating and detailing warrington0 is Warrington\'s premier ceramic coating and machine polishing specialist. We are based at Unit 1 Fairclough Mill, Atherton\'s Quay, Warrington, WA5 1AH. We hold a 5.0 Google rating from 47 verified reviews and have detailed over 500 vehicles.' } },
...
const categories: { title: string; icon: string; items: FaqItem[] }[] = [
  {
    ...
    icon: '🏢',
    items: [
      { q: 'What is Car Ceramic Coating and detailing warrington0 and where are you based?', a: <>Car Ceramic Coating and detailing warrington0 is Warrington&apos;s premier{' '}<Link href="/ceramic-coating" className="text-brand-gold hover:underline">ceramic coating</Link>{' '}and{' '}<Link href="/paint-correction" className="text-brand-gold hover:underline">machine polishing</Link>{' '}specialist. We are based at Unit 1 Fairclough Mill, Atherton\'s Quay, Warrington, WA5 1AH. We hold a 5.0 Google rating from 47 verified reviews and have detailed over 500 vehicles since we opened.</> },
      { q: 'Are you a mobile service or do I need to bring my car to you?', a: 'Customers bring their vehicles to our unit at Fairclough Mill, Atherton\'s Quay, Warrington WA5 1AH. We operate from a fixed unit where we have all professional-grade equipment, products, and tools to deliver showroom-quality results.' },
      ...
      { q: 'Are you open at weekends and on bank holidays?', a: <>Yes. Car Ceramic Coating and detailing warrington0 is open 24 hours a day, 7 days a week, 365 days a year — including all bank holidays, Christmas Eve, and New Year&apos;s Day. We work around your schedule, not ours. Call{' '}<a href={`tel:${PHONE}`} className="text-brand-gold hover:underline">{PHONE_DISPLAY}</a>{' '}at any time to book.</> },
      { q: 'Are you insured?', a: 'Yes. Car Ceramic Coating and detailing warrington0 carries full public liability insurance and motor trade insurance covering all vehicles in our care. You can leave your vehicle with us with complete confidence.' },
      { q: 'Do you use eco-friendly products?', a: 'Yes. All Car Ceramic Coating and detailing warrington0 products are water-efficient, pH-neutral where appropriate, and biodegradable. We avoid harsh chemicals that damage paintwork, contaminate driveways, or pose a risk to children, pets, or garden plants. Professional results do not require environmentally damaging products.' },
    ],
  },
  {
    title: 'Pricing',
    icon: '💰',
    items: [
      { q: 'How much does car detailing cost in Warrington?', a: <>Car Ceramic Coating and detailing warrington0 pricing for{' '}<Link href="/car-detailing" className="text-brand-gold hover:underline">car detailing in Warrington</Link>{' '}starts from £80 for an exterior or interior detail and ranges to £500 or more for a full ceramic coating with machine polishing. Common packages: exterior or interior detail from £80 · full car detail from £150 · machine polishing from £200 · ceramic coating from £350 · headlight restoration from £50. <Link href="/get-a-quote" className="text-brand-gold hover:underline">Contact us for a free exact quote</Link>.</> },
      ...
      { q: 'Are there any hidden fees?', a: 'No. Car Ceramic Coating and detailing warrington0 operates a strict no-hidden-fees policy. The price in your quote is the price you pay. We will always flag any additional findings before doing any extra work — you are in control at every stage.' },
  ...
  },
  {
    ...
    items: [
      ...
      { q: 'Which service does my car actually need?', a: 'If your car is relatively new, well-maintained and you simply want it clean and fresh, a full car detail is usually sufficient. If your paintwork has swirl marks, scratches, faded areas, oxidation or dull finish, machine polishing is needed. If you want long-term protection that lasts years, ceramic coating is the right choice. When you contact Car Ceramic Coating and detailing warrington0, we assess your vehicle and recommend exactly what it needs — never more than necessary.' },
      { q: 'What is included in a full car valet?', a: 'Our full car valet includes: exterior snow foam pre-wash, hand wash using two-bucket method, wheel and tyre cleaning, door shuts and jambs cleaned, glass cleaned inside and out, all interior surfaces wiped and dressed, seats vacuumed, carpets vacuumed, dashboard and centre console cleaned, exterior dried and finished with a spray wax.' },
      { q: 'What is included in a full car detail?', a: 'Our full car detail includes everything in the full car valet plus: iron fallout removal, clay bar decontamination, paint inspection under LED lighting, single or multi-stage machine polishing to remove swirl marks and scratches, panel wipe with IPA solution, paint sealant or wax application, interior deep clean including leather conditioning or fabric protection, glass polished with rain repellent, and final quality inspection.' },
    ],
  },
  {
    ...
    items: [
      ...
      { q: 'How long does ceramic coating last?', a: 'A professionally applied ceramic coating lasts between 2 and 5 years depending on the product grade and how the vehicle is maintained. Consumer-grade coatings sold in supermarkets last 3–6 months. Car Ceramic Coating and detailing warrington0 uses professional-only products not available to the public, applied under controlled conditions after full paint correction.' },
      { q: 'Does my car need paint correction before ceramic coating?', a: 'Yes, almost always. Ceramic coating locks in the current condition of your paintwork. If swirl marks, scratches or water spots are present before coating, they will be sealed in permanently. Car Ceramic Coating and detailing warrington0 will always inspect your paint under LED lighting and recommend the appropriate level of correction before any coating is applied.' },
      { q: 'How long does ceramic coating take?', a: 'A full ceramic coating package at Car Ceramic Coating and detailing warrington0 typically takes 1–2 days. Day one covers the full decontamination, paint correction and surface preparation. Day two covers coating application and initial cure time. This cannot be rushed — proper preparation is what makes the coating last.' },
      { q: 'Can I wash my car after ceramic coating?', a: 'You should avoid washing your vehicle for 7 days after coating to allow full curing. After that, your car can be washed normally using pH-neutral car shampoo. Avoid automated car washes with brushes, which can introduce swirl marks. Car Ceramic Coating and detailing warrington0 provides full aftercare guidance with every ceramic coating package.' },
  ...
  },
  {
    ...
    icon: '🪑',
    items: [
      { q: 'What does an interior detail include?', a: <><Link href="/interior-detailing" className="text-brand-gold hover:underline">Car Ceramic Coating and detailing warrington0&apos;s interior detailing service</Link>{' '}includes: full vacuum of all carpets, mats, seats, and boot; steam cleaning of all fabric surfaces; leather cleaning and conditioning; cleaning of dashboard, door cards, centre console and steering wheel; air vent cleaning; door shut cleaning; glass cleaned inside; odour treatment; and UV protectant applied to all plastics and leather.</> },
      ...
      { q: 'Can you remove bad smells from a car?', a: 'Yes. Car Ceramic Coating and detailing warrington0 offers full odour elimination using ozone treatment and enzyme-based odour neutralisers for persistent smells including cigarette smoke, pet odour, food, mould and damp. Air fresheners mask smells temporarily — our treatment eliminates the source. Results are permanent when the source of the odour has been removed.' },
  ...
  },
  {
    ...
    items: [
      ...
      { q: 'How does the service work?', a: <>You call or{' '}<Link href="/get-a-quote" className="text-brand-gold hover:underline">contact us for a quote</Link>, choose a date and time, and bring your vehicle to our unit at Fairclough Mill, Atherton\'s Quay, Warrington WA5 1AH. Our team has everything needed — machine polishers, steam cleaners, all professional products and tools. We complete the work and you collect a transformed vehicle.</> },
    ],
  },
  {
    title: 'Vehicle Types',
    ...
    items: [
      ...
      { q: 'Do you detail motorbikes?', a: 'Yes. Car Ceramic Coating and detailing warrington0 offers motorcycle detailing and ceramic coating. The process is adapted for two-wheeled vehicles and includes frame cleaning, exhaust polishing, wheel detailing, and paint or tank protection. All motorcycle work is priced individually — contact us for a quote.' },
    ],
  },
];
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="mt-6 max-w-3xl">
            ...
            <p className="text-gray-300 text-lg leading-relaxed mb-4">
              Car Ceramic Coating and detailing warrington0 answers every common question about professional{' '}
              ...
              in Warrington. From pricing and process to machine polishing and coverage — if
