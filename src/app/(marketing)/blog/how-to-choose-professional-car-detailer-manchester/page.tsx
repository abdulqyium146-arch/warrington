...
export const metadata: Metadata = {
  title: 'How to Choose a Professional Car Detailer in Manchester | Car Ceramic Coating and detailing warrington0',
  description:
  ...
  openGraph: {
    ...
    authors: ['Car Ceramic Coating and detailing warrington0'],
