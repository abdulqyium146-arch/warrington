...
export const metadata: Metadata = {
  title: 'Car Detailing Blog Warrington | Tips & Advice | Car Ceramic Coating and detailing warrington0',
  description:
    'Expert car detailing tips, guides and advice from Car Ceramic Coating and detailing warrington0. Learn about ceramic coating, paint correction, valeting and keeping your car in top condition.',
  alternates: { canonical: `${SITE_URL}/blog` },
  openGraph: {
    title: 'Car Detailing Blog Warrington | Tips & Advice | Car Ceramic Coating and detailing warrington0',
    description:
      'Expert car detailing tips, guides and advice from Car Ceramic Coating and detailing warrington0. Ceramic coating, paint correction, valeting and more.',
    url: `${SITE_URL}/blog`,
    type: 'website',
  },
};
