...
const GALLERY_IMAGES = [
  {
    loc: `${SITE_URL}/gallery/warrington-car-exterior-detailing-1.jpg`,
  ...
  {
    loc: `${SITE_URL}/gallery/warrington-car-valeting-service-1.jpg`,
    title: 'Car valeting service in Warrington',
    caption: 'Full car valeting service in Warrington by WCD Car Detailing',
  },
  {
    loc: `${SITE_URL}/gallery/warrington-paint-correction-swirl-removal-1.jpg`,
  ...
  {
    loc: `${SITE_URL}/gallery/warrington-ceramic-coating-application-1.jpg`,
...
export async function GET() {
  const galleryPageUrl = `${SITE_URL}/gallery`;
