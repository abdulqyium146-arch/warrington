...
export const metadata: Metadata = {
  title: 'Page Not Found | Car Ceramic Coating and detailing warrington0',
  description: 'The page you were looking for could not be found. Return to Car Ceramic Coating and detailing warrington0.',
