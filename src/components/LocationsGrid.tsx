    ...
    <section className={`py-16 ${dark ? 'bg-brand-black' : 'bg-brand-darkgray'}`}>
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-10">
          <p className="section-subheading">Serving Warrington & Surrounding Areas</p>
          <h2 className="section-heading">Areas We Cover</h2>
          <div className="gold-divider" />
          <p className="text-gray-400 mt-4 max-w-xl mx-auto text-sm">
            Car Ceramic Coating and detailing warrington0 provides professional car detailing from our unit at Fairclough Mill, Atherton\'s Quay, Warrington WA5. Customers from across the North West bring their vehicles to us.
          </p>
        </div>
