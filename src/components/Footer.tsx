...
const footerLinks = {
  services: [
    ...
    { label: 'Machine Polishing', href: '/paint-correction' },
  ...
  company: [
    { label: 'About Car Ceramic Coating and detailing warrington0', href: '/about' },
    { label: 'Gallery', href: '/gallery' },
    { label: 'Blog', href: '/blog' },
    { label: 'FAQ', href: '/faq' },
    { label: 'Contact', href: '/contact' },
    { label: 'Call Support', href: '/contact-call-support' },
    ...
    <footer role="contentinfo" className="bg-brand-black border-t border-brand-gray">
      ...
      <div className="bg-gradient-gold py-12 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-brand-black/80 mb-6 text-lg">
            Book your car detailing, ceramic coating or machine polishing in Warrington today.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              ...
              aria-label={`Call Car Ceramic Coating and detailing warrington0 on ${PHONE_DISPLAY}`}
            >
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 lg:gap-10">
          ...
          <div className="col-span-2 md:col-span-3 lg:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <div>
                <div className="font-heading font-black text-brand-white text-lg">Car Ceramic Coating and detailing warrington0</div>
                <div className="text-brand-gold text-xs font-semibold tracking-widest">CAR DETAILING</div>
              </div>
            </div>
            <p className="text-gray-400 text-sm leading-relaxed mb-4">
              Warrington&apos;s premier ceramic coating &amp; machine polishing specialists.
            ...
            <address className="not-italic text-sm text-gray-400 space-y-1 mb-4">
              <div className="font-semibold text-brand-white">Car Ceramic Coating and detailing warrington0</div>
              <div>{ADDRESS}</div>
              <div className="pt-1">
                <a
                  href={`tel:${PHONE}`}
              ...
              <div className="text-gray-400 text-xs pt-1">Open 24 hours · 7 days a week</div>
            </address>
            {/* Rating badge */}
            <div className="p-3 bg-brand-darkgray border border-brand-gray rounded-lg inline-block">
              ...
              <div className="text-gray-400 text-xs">47 Google Reviews</div>
            </div>
          </div>
            ...
            <ul className="space-y-2">
              {footerLinks.services.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-gray-400 hover:text-brand-gold focus:text-brand-gold focus:underline text-sm transition-colors"
                  >
                    {link.label}
                  </Link>
                </li>
      ...
      <div className="border-t border-brand-gray/50 bg-brand-darkgray">
        <div className="max-w-7xl mx-auto px-4 py-3 flex flex-col sm:flex-row items-center justify-center gap-3">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 bg-[#25D366] hover:bg-[#1ebe5d] text-white text-sm font-semibold px-5 py-2 rounded-full transition-colors"
          >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4" aria-hidden="true">
              ...
              <path d="M12 0C5.373 0 0 5.373 0 12c0 2.123.554 4.118 1.528 5.851L.057 23.428a.75.75 0 0 0 .915.915l5.578-1.471A11.943 11.943 0 0 0 12 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 21.75a9.692 9.692 0 0 1-4.944-1.354l-.355-.211-3.668.968.983-3.595-.232-.371A9.714 9.714 0 0 1 2.25 12C2.25 6.615 6.615 2.25 12 2.25S21.75 6.615 21.75 12 17.385 21.75 12 21.75z"/>
            </svg>
            {PHONE_DISPLAY}
          </a>
        </div>
      ...
      <div className="border-t border-brand-gray/50">
        <div className="max-w-7xl mx-auto px-4 py-4 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-gray-400">
          <p>© {year} Car Ceramic Coating and detailing warrington0. All rights reserved.</p>
          <p>
            Powered by{' '}
            <a
