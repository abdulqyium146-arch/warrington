...
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-20 right-4 lg:bottom-8 lg:right-6 z-50 flex items-center gap-2 bg-[#25D366] hover:bg-[#1ebe5d] text-white font-semibold rounded-full shadow-lg shadow-black/40 transition-all duration-300 hover:scale-105 group"
    >
      {/* Icon */}
      <span className="flex items-center justify-center w-14 h-14 rounded-full flex-shrink-0">
